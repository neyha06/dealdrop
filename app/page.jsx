...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
      <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 flex justify-content-between items-center top-0 sticky z-10">
        <div className="max-w-7xl mx-auto w-full px-4 py-3 flex justify-between items-center">
          <div className="display-flex gap-3 item-center">
            <Image
          ...
          <Button
            variant="default"
            size="sm"
            className="bg-orange-500 hover:bg-color-600 gap-2 text-white"
          >
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            {""}
            Track prices from any e-commerce sit. Get instant alerts when prics
